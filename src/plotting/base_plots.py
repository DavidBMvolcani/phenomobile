...
def plot_prediction_vs_actual(features, target, df, condition=None, show=True):
    """
...
def plot_heatmap_of_r2_score_of_ndi(r2_ndi_df, model, target, show=True):
    """
...
def plot_linear_regression_generic(trainable_features, target, df, 
